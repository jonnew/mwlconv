...
def main():
    ...
    parse.add_argument("-i", "--input", nargs='*', help="File(s) to convert. Defaults to stdin.", type=str, required=True)
    ...
    parse.add_argument("-I", "--invert", help="Invert data around 0.", action='store_true')
